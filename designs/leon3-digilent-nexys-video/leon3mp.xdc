...
## Ethernet
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS25 } [get_ports { phy_int }]; #IO_L6N_T0_VREF_13 Sch=eth_int_b

set_property -dict { PACKAGE_PIN AA16  IOSTANDARD LVCMOS25 } [get_ports { phy_mdc }]; #IO_L1N_T0_13 Sch=eth_mdc
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS25 } [get_ports { phy_mdio }]; #IO_L1P_T0_13 Sch=eth_mdio

#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS25 } [get_ports { eth_pme_b }]; #IO_L6P_T0_13 Sch=eth_pme_b

set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { phy_reset }]; #IO_25_34 Sch=eth_rst_b

set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS25 } [get_ports { phy_rxclk }]; #IO_L13P_T2_MRCC_13 Sch=eth_rxck
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS25 } [get_ports { phy_rxctl_rxdv }]; #IO_L10N_T1_13 Sch=eth_rxctl
set_property -dict { PACKAGE_PIN AB16  IOSTANDARD LVCMOS25 } [get_ports { phy_rxd[0] }]; #IO_L2P_T0_13 Sch=eth_rxd[0]
set_property -dict { PACKAGE_PIN AA15  IOSTANDARD LVCMOS25 } [get_ports { phy_rxd[1] }]; #IO_L4P_T0_13 Sch=eth_rxd[1]
set_property -dict { PACKAGE_PIN AB15  IOSTANDARD LVCMOS25 } [get_ports { phy_rxd[2] }]; #IO_L4N_T0_13 Sch=eth_rxd[2]
set_property -dict { PACKAGE_PIN AB11  IOSTANDARD LVCMOS25 } [get_ports { phy_rxd[3] }]; #IO_L7P_T1_13 Sch=eth_rxd[3]
set_property -dict { PACKAGE_PIN AA14  IOSTANDARD LVCMOS25 } [get_ports { phy_txclk }]; #IO_L5N_T0_13 Sch=eth_txck
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS25 } [get_ports { phy_txctl_txen }]; #IO_L10P_T1_13 Sch=eth_txctl
set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS25 } [get_ports { phy_txd[0] }]; #IO_L11N_T1_SRCC_13 Sch=eth_txd[0]
set_property -dict { PACKAGE_PIN W12   IOSTANDARD LVCMOS25 } [get_ports { phy_txd[1] }]; #IO_L12N_T1_MRCC_13 Sch=eth_txd[1]
set_property -dict { PACKAGE_PIN W11   IOSTANDARD LVCMOS25 } [get_ports { phy_txd[2] }]; #IO_L12P_T1_MRCC_13 Sch=eth_txd[2]
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS25 } [get_ports { phy_txd[3] }]; #IO_L11P_T1_SRCC_13 Sch=eth_txd[3]
...
create_clock -period 20.000 -name phy_rxclk [get_ports phy_rxclk]
...
# CDC
set_max_delay -datapath_only -from [all_registers -clock [get_clocks -include_generated_clocks sysclk]    ] -to [all_registers -clock [get_clocks phy_rxclk]                           ] 8.000
set_max_delay -datapath_only -from [all_registers -clock [get_clocks phy_rxclk]                           ] -to [all_registers -clock [get_clocks -include_generated_clocks sysclk]    ] 8.000

set_false_path -from [get_clocks clk_pll_i] -to [get_clocks clk_nobuf_1]
set_false_path -from [get_clocks clk_pll_i] -to [get_clocks clk90_nobuf_1]
set_false_path -from [get_clocks clk_nobuf_1] -to [get_clocks clk_pll_i]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets eth0.rgmii0/useclkmux0.tecclkmux.clkmux10_100/tec.xil.buf/clk10_100]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets eth0.rgmii0/useclkmux0.tecclkmux.clkmux10_100d/tec.xil.buf/clk10_100_del]
